...
public class DustrialRecipeProvider extends FabricRecipesProvider {
    ...
    protected void generateRecipes(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapedRecipeJsonFactory.create(ANCHOR).input('$',LARGE_CHAIN).input('#', Items.IRON_INGOT).pattern(" $ ").pattern(" # ").pattern("# #").criterion("has_large_chain",conditionsFromItem(DustrialBlocks.LARGE_CHAIN)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(HOOK).input('$',LARGE_CHAIN).input('#', Items.IRON_INGOT).pattern(" $").pattern(" #").pattern("# ").criterion("has_large_chain",conditionsFromItem(DustrialBlocks.LARGE_CHAIN)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(BARBED_CHAIN_LINK_FENCE,16).input('$', Items.IRON_NUGGET).input('#', Blocks.CHAIN).pattern("#$#").pattern("$#$").pattern("#$#").criterion("has_chain",conditionsFromItem(Items.CHAIN)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(BARBED_IRON_BARS,16).input('$', Items.IRON_NUGGET).input('#', Items.IRON_INGOT).pattern("$$$").pattern("###").pattern("###").criterion("has_chain",conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        ...
        //cardboard
        ShapedRecipeJsonFactory.create(DustrialItems.CARDBOARD, 2).input('#', Items.PAPER).pattern("##").pattern("##").criterion("has_paper",conditionsFromItem(Items.PAPER)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(DustrialItems.CARDBOARD_HELMET).input('#', DustrialItems.CARDBOARD).pattern("###").pattern("# #").criterion("has_cardboard",conditionsFromItem(DustrialItems.CARDBOARD)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(DustrialItems.CARDBOARD_CHESTPLATE).input('#', DustrialItems.CARDBOARD).pattern("# #").pattern("###").pattern("###").criterion("has_cardboard",conditionsFromItem(DustrialItems.CARDBOARD)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(DustrialItems.CARDBOARD_LEGGINGS).input('#', DustrialItems.CARDBOARD).pattern("###").pattern("# #").pattern("# #").criterion("has_cardboard",conditionsFromItem(DustrialItems.CARDBOARD)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(DustrialItems.CARDBOARD_BOOTS).input('#', DustrialItems.CARDBOARD).pattern("# #").pattern("# #").criterion("has_cardboard",conditionsFromItem(DustrialItems.CARDBOARD)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(DustrialBlocks.CARDBOARD_SCRAP, 8).input('#', DustrialTags.CARDBOARD_BLOCKS).pattern("###").pattern("# #").pattern("###").criterion("has_cardboard",conditionsFromTag(DustrialTags.CARDBOARD_BLOCKS)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(DustrialBlocks.CAST_IRON_BALUSTRADE, 16).input('#', DustrialItems.CAST_IRON_BILLET).pattern("###").pattern("###").criterion(hasItem(DustrialItems.CAST_IRON_BILLET),conditionsFromItem(DustrialItems.CAST_IRON_BILLET)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(DustrialItems.CAST_IRON_BILLET, 4).input('#', Items.IRON_INGOT).input('$',Items.COAL).pattern("#$").pattern("$$").criterion(hasItem(Items.IRON_INGOT),conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(CHAIN_LINK_FENCE, 16).input('#', Blocks.CHAIN).pattern("# #").pattern(" # ").pattern("# #").criterion("has_chain",conditionsFromItem(Blocks.CHAIN)).offerTo(exporter);
        offerDetailedTrapDoorRecipe(exporter, CHAIN_TRAPDOOR, CHAIN_LINK_FENCE, Items.IRON_INGOT);
        //cinder
        ShapedRecipeJsonFactory.create(CINDER_BLOCK, 4).input('#', DustrialTags.CONCRETE_POWDER).input('$',Items.COAL).pattern("#$").pattern("$#").criterion("has_concrete",conditionsFromTag(DustrialTags.CONCRETE_POWDER)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(INDUSTRIAL_IRON_BILLET, 4).input('#', Items.IRON_INGOT).input('$',Items.COAL).pattern("#$").pattern("$#").criterion("has_iron_ingot",conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(INDUSTRIAL_IRON_TRAPDOOR).input('#', INDUSTRIAL_IRON_BILLET).pattern("##").pattern("##").criterion("has_industrial_billet",conditionsFromItem(INDUSTRIAL_IRON_BILLET)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(IRON_BAR_TRAPDOOR).input('#', Items.IRON_BARS).pattern("##").pattern("##").criterion("has_iron_bars",conditionsFromItem(Items.IRON_BARS)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(PADDED_BLOCK, 4).input('#', MINI_PADDED_BLOCK).pattern("##").pattern("##").criterion("has_mini_padded_blocks",conditionsFromItem(MINI_PADDED_BLOCK)).offerTo(exporter,new Identifier("padded_block_from_mini"));
        ShapedRecipeJsonFactory.create(PADDED_DOOR, 3).input('#', DustrialTags.PADDED_BLOCKS).input('$', INDUSTRIAL_IRON_BILLET).pattern("##").pattern("#$").pattern("##").criterion("has_padded", conditionsFromTag(DustrialTags.PADDED_BLOCKS)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(PADDED_TRAPDOOR).input('#', DustrialTags.PADDED_BLOCKS).input('$', INDUSTRIAL_IRON_BILLET).pattern("#$#").pattern("###").criterion("has_padded", conditionsFromTag(DustrialTags.PADDED_BLOCKS)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(RUSTY_IRON_TRAPDOOR).input('#', RUSTY_IRON_INGOT).pattern("##").pattern("##").criterion("has_rusty_ingot",conditionsFromItem(RUSTY_IRON_INGOT)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(RUSTY_SHEET_METAL_SIDING, 16).input('#', RUSTY_SHEET_METAL).pattern("# #").pattern("# #").pattern("# #").criterion("has_rusty_sheet", conditionsFromItem(RUSTY_SHEET_METAL)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(RUSTY_SHEET_METAL_TRAPDOOR).input('#', RUSTY_SHEET_METAL).pattern("##").pattern("##").criterion("has_rusty_sheet", conditionsFromItem(RUSTY_SHEET_METAL)).offerTo(exporter);
        //maybe should do that little X pttrn
        ShapedRecipeJsonFactory.create(RUSTY_SHEET_METAL_TREADING, 6).input('#', RUSTY_SHEET_METAL).input('$',Items.IRON_NUGGET).pattern("#$").pattern("$#").criterion("has_rusty_sheet",conditionsFromItem(RUSTY_SHEET_METAL)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(RUSTY_SHEET_METAL_WALLING,16).input('#', RUSTY_SHEET_METAL).pattern("###").pattern("   ").pattern("###").criterion("has_rusty_sheet", conditionsFromItem(RUSTY_SHEET_METAL)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(SHEET_METAL, 3).input('#', Items.IRON_INGOT).pattern("###").criterion("has_iron_ingot", conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(SHEET_METAL_SIDING, 16).input('#', SHEET_METAL).pattern("# #").pattern("# #").pattern("# #").criterion("has_metal_sheet", conditionsFromItem(SHEET_METAL)).offerTo(exporter);
        ...
        ShapedRecipeJsonFactory.create(SHEET_METAL_TRAPDOOR).input('#', SHEET_METAL).pattern("##").pattern("##").criterion("has_sheet_metal",conditionsFromItem(SHEET_METAL)).offerTo(exporter);
        ShapedRecipeJsonFactory.create(SHEET_METAL_TREADING, 6).input('#', SHEET_METAL).input('$',Items.IRON_NUGGET).pattern("#$").pattern("$#").criterion("has_sheet_metal",conditionsFromItem(SHEET_METAL)).offerTo(exporter);
        offerSlabNStairsRecipes(exporter, SHEET_METAL_TREADING_SLAB, SHEET_METAL_TREADING_STAIRS, SHEET_METAL_TREADING);
        ShapedRecipeJsonFactory.create(SHEET_METAL_WALLING,16).input('#', SHEET_METAL).pattern("###").pattern("   ").pattern("###").criterion("has_sheet_metal", conditionsFromItem(SHEET_METAL)).offerTo(exporter);
...
//    public static void offerShapedRecipe
    public static void offerDetailedDoorRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible base, ItemConvertible detail){
        ShapedRecipeJsonFactory.create(output, 3).input('#', base).input('$', detail).pattern("##").pattern("#$").pattern("##").criterion(hasItem(base), conditionsFromItem(base)).offerTo(exporter);
    }
    public static void offerDetailedTrapDoorRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible base, ItemConvertible detail){
        ShapedRecipeJsonFactory.create(output).input('#', base).input('$', detail).pattern("#$#").pattern("###").criterion(hasItem(base), conditionsFromItem(base)).offerTo(exporter);
    }
    public static void offerChainRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible input1, ItemConvertible input2, int count){
        ShapedRecipeJsonFactory.create(output,count).input('#', input1).input('$', input2).pattern("#").pattern("$").pattern("#").criterion(hasItem(input1), conditionsFromItem(input1)).offerTo(exporter);
    }
    public static void offerEmptyFrameRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible surround , int count){
        ShapedRecipeJsonFactory.create(output, count).input('#', surround).pattern("###").pattern("# #").pattern("###").criterion(hasItem(surround), conditionsFromItem(surround)).offerTo(exporter);
    }
    public static void  offerFramedRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible center,ItemConvertible around , int count){
        ShapedRecipeJsonFactory.create(output, count).input('#', around).input('$',center).pattern("###").pattern("#$#").pattern("###").criterion(hasItem(around), conditionsFromItem(around)).offerTo(exporter);
    }
    ...
    public static void offerLargeLanternRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible heart){
        ShapedRecipeJsonFactory.create(output).input('#', Items.IRON_INGOT).input('$', heart).input('G', Items.GLOWSTONE).pattern("###").pattern("$G$").pattern("###").criterion(hasItem(heart), conditionsFromItem(heart)).offerTo(exporter);
    }
    public static void offerNeonLightRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible surround) {
        ShapedRecipeJsonFactory.create(output, 8).input('#', surround).input('$', Blocks.GLOWSTONE).pattern("###").pattern("#$#").pattern("###").group("neon_light").criterion("has_glowstone", conditionsFromItem(Blocks.GLOWSTONE)).offerTo(exporter);
    }
    public static void offerNeonLightRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible surround, String name) {
        ShapedRecipeJsonFactory.create(output, 8).input('#', surround).input('$', Blocks.GLOWSTONE).pattern("###").pattern("#$#").pattern("###").group("neon_light").criterion("has_glowstone", conditionsFromItem(Blocks.GLOWSTONE)).offerTo(exporter,name);
    }
    ...
    public static void offerVerticalSlabRecipes(Consumer<RecipeJsonProvider> vertExporter, ItemConvertible output, ItemConvertible input){
        ShapedRecipeJsonFactory.create(output,3).input('#', input).pattern("#").pattern("#").pattern("#").criterion("has_slab",conditionsFromItem(input)).offerTo(vertExporter,"vertical/"+output.asItem().toString());
